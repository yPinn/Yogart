...
def generate_framesG():
    ...
    while cap.isOpened():
        ...
        if results.pose_landmarks:
            ...
            # 檢查 Triangle Pose定義的角度範圍
            if (165 < left_knee_angle < 195 and 165 < right_knee_angle < 195):
                calf_color = green_drawing_spec
            else:
                calf_color = red_drawing_spec

            if (60 < left_shoulder_angle < 120 and 60 < right_shoulder_angle < 120):
                elbow_color = green_drawing_spec
            else:
                elbow_color = red_drawing_spec

            if (90 < left_back_angle < 150 and 75 < right_back_angle < 105):
            ...
            cv2.putText(frame, 'Triangle Pose', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
