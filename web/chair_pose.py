...
def generate_framesD():
    ...
    while cap.isOpened():
        ...
        if results.pose_landmarks:
            ...
            if (240 < right_knee_angle < 270 or 90 < left_knee_angle < 120):
                calf_color = green_drawing_spec
            else:
                calf_color = red_drawing_spec

            if (110 < right_back_angle < 140 or 220 < left_back_angle < 250):
            ...
            if (100 < right_shoulder_angle < 180 or 100 < left_shoulder_angle < 180):
            ...
            cv2.putText(frame, 'Chair Pose', (10, 30),
                        cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)

        cv2.imshow('Chair Pose', frame)
