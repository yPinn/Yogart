...
def generate_framesF():
    ...
    while cap.isOpened():
        ...
        if results.pose_landmarks:
            ...
            # 檢查 Tree Pose 定義的角度範圍
            if (165 < left_knee_angle < 195 or 165 < right_knee_angle < 195) and (240 < left_knee_angle < 300 or 60 < right_knee_angle < 120):
            ...
            if (100 < left_back_angle < 150 or 100 < right_back_angle < 150) and (160 < left_back_angle < 200 or 160 < right_back_angle < 200):
            ...
            cv2.putText(frame, 'Tree Pose', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
