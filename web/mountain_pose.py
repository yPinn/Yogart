...
def generate_framesE():
    ...
    while cap.isOpened():
        ...
        if results.pose_landmarks:
            ...
            back_color = red_drawing_spec
        
            
            # 檢查 mountain Pose 定義的角度範圍
            ...
            if (5 < left_shoulder_angle < 20 and 5 < right_shoulder_angle < 20):
            ...
            cv2.putText(frame, 'Mountain Pose', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
        
        cv2.imshow('Mountain Pose', frame)
