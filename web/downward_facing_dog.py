...
def generate_frameC():
    ...
    while cap.isOpened():
        ...
        if results.pose_landmarks:
            ...
            if (165 < right_knee_angle < 195 or  165 < left_knee_angle < 195):
                calf_color = green_drawing_spec
            else:
                calf_color = red_drawing_spec

            if (80 < right_back_angle < 160 or 80 < left_back_angle < 160):
            ...
            cv2.putText(frame, 'Downward Facing Dog Pose', (10, 30),
                        cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)

        cv2.imshow('Downward Facing Dog Pose', frame)
