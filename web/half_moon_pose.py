...
def generate_framesH():
    ...
    while cap.isOpened():
        ...
        if results.pose_landmarks:
            ...
            # 檢查 half moon Pose 定義的角度範圍
            if (165 < left_knee_angle < 195 or 165 < right_knee_angle < 195) and (165 < left_knee_angle < 195 or 165 < right_knee_angle < 195):
                calf_color = green_drawing_spec
            else:
                calf_color = red_drawing_spec

            if (60 < left_back_angle < 100 or 200 < right_back_angle < 300):
                thigh_color = green_drawing_spec
                body_color = green_drawing_spec
            else:
                thigh_color = green_drawing_spec
                body_color = red_drawing_spec

            if (70 < left_shoulder_angle < 150 and 70 < right_shoulder_angle < 130) or (70 < left_shoulder_angle < 130 and 70 < right_shoulder_angle < 150):
                elbow_color = green_drawing_spec
            else:
                elbow_color = red_drawing_spec

            if (160 < right_hand_angle < 200 or 160 < left_hand_angle < 200):
            ...
            cv2.putText(frame, 'Half Moon Pose', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
        
        cv2.imshow('Half Moon Pose', frame)
