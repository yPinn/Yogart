...
class PoseDetector:
    ...
    def process_frame(self, frame):
        with self.detection_lock:
            if not self.detection_ongoing:
                self.detection_ongoing = True
                # Start pose detection in a new thread
                detection_thread = Thread(target=self.pose_detection_thread)
        ...
        if results.pose_landmarks:
            ...
            left_elbow_angle = self.calculate_angle(landmarks[mp_pose.PoseLandmark.LEFT_SHOULDER],
            ...
            if (90 < right_knee_angle < 150 and 165 < left_knee_angle < 195) or (165 < right_knee_angle < 195 and 210 < left_knee_angle < 270) or (90 < right_knee_angle < 150 and 165 < left_knee_angle < 195) or (165 < right_knee_angle < 195 and 210 < left_knee_angle < 270):
