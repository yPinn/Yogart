...
def generate_framesB():
    ...
    while cap.isOpened():
        ...
        if results.pose_landmarks:
            ...
            if ((165 < left_knee_angle < 195 or 165 < right_knee_angle < 195) or (210 < left_knee_angle < 270 or 90 < right_knee_angle < 150)):
                calf_color = green_drawing_spec
            else:
                calf_color = red_drawing_spec

            if (left_hip_angle > 110 and right_hip_angle > 110):
            ...
            if (165 < right_hand_angle < 195 or 165 < left_hand_angle < 195):
            ...
            cv2.putText(frame, 'Warrior II Pose', (10, 30),
