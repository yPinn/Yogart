...
def generate_framesI():
    ...
    while cap.isOpened():
        ...
        if results.pose_landmarks:
            ...
            # 檢查 Full boat Pose 定義的角度範圍
            if (160 < left_knee_angle < 200 or 160 < right_knee_angle < 200):
            ...
            if (50 < left_back_angle <120 or 240 < right_back_angle <310):
                body_color = green_drawing_spec
            else:
                body_color = red_drawing_spec

            if (30 < left_shoulder_angle < 70 or 30 < right_shoulder_angle < 70):
                elbow_color = green_drawing_spec
            else:
                elbow_color = red_drawing_spec

            if (160 < right_elbow_angle < 200 or 160 < left_elbow_angle < 200):
            ...
            cv2.putText(frame, 'Full Boat Pose', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
        
        cv2.imshow('Full Boat Pose', frame)
