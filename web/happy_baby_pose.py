...
def generate_framesJ():
    ...
    while cap.isOpened():
        ...
        if results.pose_landmarks:
            ...
            # 檢查 happy baby Pose 定義的角度範圍
            if (230 < left_knee_angle < 290 or 70 < right_knee_angle < 130) :
            ...
            cv2.putText(frame, 'Happy Baby Pose', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
        
        cv2.imshow('Happy Baby Pose', frame)
